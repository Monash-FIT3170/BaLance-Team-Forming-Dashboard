...
function CreateGroups() {
  ...
  const validateFields = () => {
    ...
    if (!viableStrats[strategy] && strategy !== 'random') {
      errors.push(
        `cannot form groups using ${strategy}: ${strategy} data has not been uploaded`
      );
    }
  ...
  const setGroupSizeField = () => {
    if (strategy !== "times") {
        ...
        return <FormHelperText>Preset group sizes are not compatible with this strategy.</FormHelperText>;
    }
  } 
