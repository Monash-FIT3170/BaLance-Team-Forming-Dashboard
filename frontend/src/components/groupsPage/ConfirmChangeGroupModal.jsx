        ...
        <>
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    ...
                    <ModalCloseButton />
                    <ModalBody>
                        The group you wish to move the student to is in a different lab to their current allocation. Are you sure you wish to proceed?
                    </ModalBody>
                    ...
                    <ModalFooter>
                        ...
                        <Button variant='ghost' onClick={handleStudentGroupChange}>Confirm</Button>
                    </ModalFooter>
                </ModalContent>
            </Modal>
        </>
