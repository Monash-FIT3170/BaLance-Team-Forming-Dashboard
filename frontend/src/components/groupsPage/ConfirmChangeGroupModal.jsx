...
export default function ConfirmChangeGroupModal({
    ...
    //     fetch(`/api/groups/${unitCode}/${year}/${period}/labNumber/${oldGroupNumber}`,
    //         {
    //             method: 'get',
    //             headers: new Headers({
        ...
        <>
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    ...
                    <ModalCloseButton />
                    <ModalBody>
                        The group you wish to move the student to is in a different lab to
                        their current allocation. Are you sure you wish to proceed?
                    </ModalBody>
