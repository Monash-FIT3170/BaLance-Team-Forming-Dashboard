...
const CreateUnitModal = ({ isModalOpen, onModalClose }) => {
    ...
    const validateFields = () => {
        ...
        if (unitCode === '') {
            ...
            errors.push(
                'unit code must consist of letters and/or numbers only and cannot exceed 7 characters'
            );
        }
        ...
        if (unitName === '') {
            ...
            errors.push(
                'unit name must consist of letters and/or numbers only and cannot exceed 50 characters'
            );
        }
                    ...
                    <Flex direction="row" spacing={4} justifyContent="space-between">
                        ...
                        <VStack>
                            ...
                            <Dropdown
                                ...
                                onChange={(event) => {
                                    setUnitPeriod(event.target.value);
                                }}
            ...
            <ModalContent>
                ...
                <ModalBody pb={10}>
                    {!submitted ? (
                        ...
                        <Text>Would you like to add student data to the offering?</Text>
                    )}
                </ModalBody>
                ...
                {!submitted ? (
                    ...
                    <ModalFooterButtonPair
                        ...
                        confirmButtonOnClick={() =>
                            navigate(`/uploadData/${unitCode}/${unitYear}/${unitPeriod}`)
                        }
