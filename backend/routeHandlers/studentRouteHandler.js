  ...
  try {
    ...
    try {
      ...
      await connection.execute(
        // delete effort personality test results for student
      ...
      await connection.execute(
        // delete belbin personality test results for student
      ...
      await connection.execute(
        // delete personality test attempt for student
      ...
      await connection.execute(
        // delete group allocation for student
      ...
      await connection.execute(
        // delete lab allocation for student
      ...
      await connection.execute(
        // delete unit enrolment for student
...
const updateStudent = async (req, res) => {
  ...
  try {
    const updateQuery =
      "UPDATE student " + "SET preferred_name=?, last_name=?, email_address=?, wam_val=? " + "WHERE student_id=? ";
...
const addStudentBelbin = async (personalityTestAttemptKeys, students) => {
  ...
  try {
    await promiseBasedQuery("INSERT IGNORE INTO belbin_result (personality_test_attempt, belbin_type) " + "VALUES ?;", [
      resultInsertData,
    ]);
  } catch (err) {
    console.log(err);
